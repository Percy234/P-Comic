...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _moveFeaturedPair(int delta, int itemCount) {
    ...
    setState(() {
      _featuredStartIndex =
          (_featuredStartIndex + delta + itemCount) % itemCount;
    });
  }
                        ...
                        child: InkWell(
                          onTap: () => Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (_) => FilterScreen(
                                filterTitle: 'Thể loại',
                                initialStatuses: const ['coming_soon'],
                                showBottomNav: false,
                              ),
                            ),
                          ),
                        ...
                        child: InkWell(
                          onTap: () => Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (_) => FilterScreen(
                                filterTitle: 'Thể loại',
                                initialStatuses: const ['completed'],
                                showBottomNav: false,
                              ),
                            ),
                          ),
                                        ...
                                        child: Padding(
                                          ...
                                          child: SizedBox(
                                            ...
                                            child: ComicCard(
                                              ...
                                              subtitle: _formatSubtitle(
                                                provider
                                                    .latestChapterNames[secondComic
                                                    .slug],
                                              ),
                                            ),
                                          ),
